...
namespace Origine
{
    ...
    {
        IEnumerator Initialize(string settingPath);
        ...
        /// </summary>
        IGameNotificationsPlatform Platform { get; }
        ...
        /// </summary>
        IPendingNotificationsSerializer Serializer { get; set; }
    ...
    /// </summary>
    public class GameNotificationsManager : GameModule, INotificationManager
    {
