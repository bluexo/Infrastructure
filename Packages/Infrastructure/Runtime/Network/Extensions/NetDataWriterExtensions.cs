...
#region Packed Unsigned Int (Credit: https://sqlite.org/src4/doc/trunk/www/varint.wiki)
        public static void PutPackedUShort(this NetDataWriter writer, ushort value) => PutPackedULong(writer, value);

        public static void PutPackedUInt(this NetDataWriter writer, uint value) => PutPackedULong(writer, value);
