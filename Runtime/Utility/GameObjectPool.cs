...
namespace Origine
{
    public sealed class GameObjectPool : MonoBehaviour
    {
        ...
        public static void Recycle(GameObject obj)
        {
            ...
            {
                //Debug.Log($"Object destroy {obj.name}", obj);
    ...
    public static class ObjectPoolExtensions
    {
        ...
        public static void Recycle(this GameObject obj, float delaySec)
        {
            GameObjectPool.instance.StartCoroutine(RecycleAsync(obj, delaySec));
        }
